...
export async function setup() {
  ...
  // Valid Stellar public keys (56 chars, G prefix, valid checksum)
  process.env.ISSUER_PUBLIC          = 'GBMPE4IA36LQV7BEDJHW4M2Y2B27X2OPUO5EFCCKUDHSLVXCJPSNFNSU';
  process.env.ISSUER_SECRET          = 'SAMTF66GZNEHZUEEAYCSTI6NKDVDQDM6X3B4LYPTW4FRHI2E4WO6S5E6';
  process.env.FEE_SOURCE_SECRET      = 'SAMTF66GZNEHZUEEAYCSTI6NKDVDQDM6X3B4LYPTW4FRHI2E4WO6S5E6';
  process.env.DISTRIBUTION_PUBLIC    = 'GBMPE4IA36LQV7BEDJHW4M2Y2B27X2OPUO5EFCCKUDHSLVXCJPSNFNSU';
  process.env.DISTRIBUTION_SECRET    = 'SAMTF66GZNEHZUEEAYCSTI6NKDVDQDM6X3B4LYPTW4FRHI2E4WO6S5E6';
